...
public class McpToolTests
{
    ...
    public void SearchReturnsByteForByteWhatOkfSearchJsonPrints()
    {
        ...
        var cli = Cli.Run(environment, "search", "widget pricing", vault.Root, "--json", "--limit", "3");
        var run = Mcp.Session(
            environment,
            vault.Root,
            Mcp.Call(1, "okf_search", """{"query":"widget pricing","limit":3}"""));
    ...
    public void SearchResultsCarryTrustAndStalenessAndNeverABody()
    {
        ...
        var run = Mcp.Session(
            ...
            vault.Root,
            Mcp.Call(1, "okf_search", """{"query":"widget"}"""));
    ...
    public void SearchTakesFiltersAsArraysAsBareStringsAndInline()
    {
        ...
        var run = Mcp.Session(
            McpProtocolTests.Environment(vault),
            vault.Root,
            Mcp.Call(1, "okf_search", """{"query":"widget","type":["Reference"]}"""),
            Mcp.Call(2, "okf_search", """{"query":"widget","type":"Reference"}"""),
            Mcp.Call(3, "okf_search", """{"query":"widget type:Reference"}"""),
            Mcp.Call(4, "okf_search", """{"query":"widget","tag":["catalog","widgets"]}"""));
    ...
    public void SearchWithNothingToMatchOnIsInvalidParams()
    {
        ...
        var run = Mcp.Session(
            McpProtocolTests.Environment(vault),
            vault.Root,
            Mcp.Call(1, "okf_search", "{}"),
            Mcp.Call(2, "okf_search", """{"query":"   "}"""));
    ...
    public void SearchWithAMalformedArgumentIsInvalidParams(string arguments)
    {
        ...
        var run = Mcp.Session(McpProtocolTests.Environment(vault), vault.Root, Mcp.Call(1, "okf_search", arguments));
    ...
    public void ReadAcceptsAConceptIdAsWellAsAPath()
    {
        ...
        var run = Mcp.Session(
            McpProtocolTests.Environment(vault),
            vault.Root,
            Mcp.Call(1, "okf_read", """{"path":"notes/gadgets"}"""),
            Mcp.Call(2, "okf_read", """{"path":"notes/gadgets.md"}"""));
    ...
    public void ReadRefusesEveryPathThatLeavesTheBundleRoot(string path)
    {
        ...
        var run = Mcp.Session(
            McpProtocolTests.Environment(vault),
            vault.Root,
            Mcp.Call(1, "okf_read", $$"""{"path":"{{path.Replace("\\", "\\\\", StringComparison.Ordinal)}}"}"""));
    ...
    public void ReadingAConceptThatIsNotThereIsAnErrorResultTheModelCanRecoverFrom()
    {
        ...
        var run = Mcp.Session(
            McpProtocolTests.Environment(vault),
            vault.Root,
            Mcp.Call(1, "okf_read", """{"path":"notes/sprockets.md"}"""));
    ...
    public void ReadWithoutAPathIsInvalidParams()
    {
        ...
        var run = Mcp.Session(McpProtocolTests.Environment(vault), vault.Root, Mcp.Call(1, "okf_read", "{}"));
    ...
    public void ReadNamesTheBundleWhenTwoBundlesHoldTheSamePath()
    {
        ...
        var run = Mcp.Session(
            ...
            vault.Root,
            Mcp.Call(1, "okf_read", """{"path":"widgets.md"}"""),
            Mcp.Call(2, "okf_read", """{"path":"widgets.md","bundle":"second"}"""),
            Mcp.Call(3, "okf_read", """{"path":"widgets.md","bundle":"nowhere"}"""));
    ...
    public void ListWithNoArgumentsNamesTheBundlesInScope()
    {
        ...
        var run = Mcp.Session(McpProtocolTests.Environment(vault), vault.Root, Mcp.Call(1, "okf_list"));
    ...
    public void ListUsesTheIndexABundleShipsAndSynthesizesOneWhenItDoesNot()
    {
        ...
        var run = Mcp.Session(
            ...
            Mcp.Call(2, "okf_list", """{"bundle":"bare"}"""),
            Mcp.Call(3, "okf_list", """{"bundle":"searchable","path":"notes"}"""));
    ...
    public void ListWalksIntoABundleNamedInThePathWhenSeveralAreInScope()
    {
        ...
        var run = Mcp.Session(
            McpProtocolTests.Environment(vault),
            vault.Root,
            Mcp.Call(1, "okf_list", """{"path":"searchable/notes"}"""),
            Mcp.Call(2, "okf_list", """{"path":"notes"}"""));
    ...
    public void ListRefusesEveryDirectoryThatLeavesTheBundleRoot(string path)
    {
        ...
        var run = Mcp.Session(
            McpProtocolTests.Environment(vault),
            vault.Root,
            Mcp.Call(1, "okf_list", $$"""{"bundle":"searchable","path":"{{path}}"}"""));
    ...
    public void ListingADirectoryThatIsNotThereIsAnErrorResult()
    {
        ...
        var run = Mcp.Session(
            McpProtocolTests.Environment(vault),
            vault.Root,
            Mcp.Call(1, "okf_list", """{"bundle":"searchable","path":"archive"}"""));
    ...
    public void AnUnknownToolIsInvalidParams()
    {
        ...
        var run = Mcp.Session(
            McpProtocolTests.Environment(vault),
            vault.Root,
            Mcp.Call(1, "okf_write", """{"path":"widgets.md"}"""),
            Mcp.Request(2, "tools/call", """{"arguments":{}}"""),
            Mcp.Request(3, "tools/call", """{"name":"okf_list","arguments":"not an object"}"""));
    ...
    public void TheServerReadsNothingOutsideABundleRoot()
    {
        ...
        var run = Mcp.Session(
            ...
            Mcp.Call(2, "okf_read", """{"path":"../raw/captured.md"}"""),
            Mcp.Call(3, "okf_list", """{"path":"../raw"}"""));
