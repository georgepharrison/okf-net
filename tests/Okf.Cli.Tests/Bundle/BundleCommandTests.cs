...
namespace Okf.Cli.Tests.Bundle;
...
public class BundleCommandTests
{
    ...
    public void HelpDescribesWhatIsStrippedAndExitsZero()
    {
        ...
        var run = CliHarness.RunIn(home.Root, home.Root, "bundle", "--help");
    ...
    public void PackagesTheVaultsBundlesAndStripsEverythingElse()
    {
        ...
        var run = CliHarness.RunIn(vault.Project, vault.Home, "bundle", vault.Root, "--out", archive, "--generated-at", Stamp);
    ...
    public void AnUnknownBundleNameIsRefusedBeforeAnythingIsWritten()
    {
        ...
        var run = CliHarness.RunIn(vault.Project, vault.Home, "bundle", vault.Root, "--out", archive, "--bundle", "gamma");
    ...
    public void TheFormatFollowsTheOutputNameUnlessItIsGiven()
    {
        ...
        CliHarness.RunIn(vault.Project, vault.Home, "bundle", vault.Root, "--out", zipped, "--generated-at", Stamp);
        CliHarness.RunIn(
            vault.Project,
            vault.Home,
            "bundle",
    ...
    public void OptionsAreAcceptedInTheirInlineFormToo()
    {
        ...
        var run = CliHarness.RunIn(
            ...
            "--bundle=beta",
            $"--generated-at={Stamp}");
        var verified = CliHarness.RunIn(vault.Project, vault.Home, "bundle", $"--verify={inline}");
    ...
    public void VerifyingSomethingThatIsNotAnArchiveFailsWithASentence()
    {
        ...
        var run = CliHarness.RunIn(vault.Project, vault.Home, "bundle", "--verify", impostor);
    ...
    public void TheStampGoesIntoTheManifestExactlyAsGiven()
    {
        ...
        CliHarness.RunIn(vault.Project, vault.Home, "bundle", vault.Root, "--out", archive, "--generated-at", "2026-01-02T03:04:05Z");
    ...
    public void VerboseReportsResolutionAndTheDestinationOnStderr()
    {
        ...
        var quiet = CliHarness.RunIn(vault.Project, vault.Home, "bundle", vault.Root, "--out", archive, "--generated-at", Stamp);
    ...
    public void VerifyPassesOnWhatWasJustPackaged()
    {
        using var vault = new DistributableVault();
        var archive = Path.Combine(vault.Output, "dist.tar.gz");
        CliHarness.RunIn(vault.Project, vault.Home, "bundle", vault.Root, "--out", archive, "--generated-at", Stamp);

        var run = CliHarness.RunIn(vault.Project, vault.Home, "bundle", "--verify", archive);
    ...
    public void VerifyFailsOnATamperedDirectoryAndNamesTheFile()
    {
        ...
        var run = CliHarness.RunIn(vault.Project, vault.Home, "bundle", "--verify", directory);
    ...
    public void VerifyRefusesSomethingTheBundlerNeverWrote()
    {
        ...
        var run = CliHarness.RunIn(vault.Project, vault.Home, "bundle", "--verify", vault.Root);
    ...
    public void LintOfTheDistributionUsesDefaultSeveritiesNotTheVaultsConfig()
    {
        ...
        var packaged = CliHarness.RunIn(
            ...
            "--generated-at",
            Stamp);
        var linted = CliHarness.RunIn(vault.Project, vault.Home, "lint", vault.Root);
    ...
    public void TheSameVaultAndStampProduceAByteIdenticalArchive()
    {
        ...
        CliHarness.RunIn(vault.Project, vault.Home, "bundle", vault.Root, "--out", first, "--generated-at", Stamp);
        CliHarness.RunIn(vault.Project, vault.Home, "bundle", vault.Root, "--out", second, "--generated-at", Stamp);
    ...
    public void TheDogfoodVaultPackagesVerifiesAndLintsClean()
    {
        ...
        var packaged = CliHarness.RunIn(
            ...
            "--generated-at",
            Stamp);
        var verified = CliHarness.RunIn(output.Root, output.Root, "bundle", "--verify", archive);
    ...
    private sealed class DistributableVault : IDisposable
    {
        ...
        public DistributableVault()
        {
            ...
            Project = _tree.CreateDirectory("project");
            Root = Path.Combine(Project, OkfDiscovery.VaultDirectoryName);
            Output = _tree.CreateDirectory("out");
