...
namespace Okf.Cli.Tests.Verify;
...
public class VerifyCommandTests
{
    ...
    public void HelpExitsZeroAndSaysWhichGitConfigIsRead()
    {
        ...
        var run = CliHarness.RunIn(home.Root, home.Root, "verify", "--help");
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "verify");
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "verify", "a.md", argument);
