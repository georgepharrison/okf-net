...
public class VerboseReportingTests
{
    ...
    public void VerboseNamesTheResolutionAndEveryBundle(string commandLine)
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, [.. commandLine.Split(' '), "--verbose"]);
    ...
    public void WithoutVerboseNothingIsWrittenToStandardError(string commandLine)
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, commandLine.Split(' '));
    ...
    public void LintVerboseReportsBothConfigLayersWhenNeitherExists()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "lint", "--verbose");
    ...
    public void LintVerboseReportsTheRunMetadataOnStandardErrorEvenUnderJson()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "lint", "--json", "--verbose");
    ...
    public void BundleVerboseNamesWhatItPackagesAndWhatItWrites()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "bundle", "--out", destination, "--verbose");
    ...
    public void SearchVerboseReportsScopeQueryAndMatchMode()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "search", "concept", "--scope", "project", "--verbose");
    ...
    public void InboxVerboseReportsWhatItRead()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "inbox", "--verbose");
    ...
    public void InitVerboseNamesTheVaultItScaffolds(bool personal, string expected)
    {
        ...
        var run = CliHarness.Run(CliHarness.Environment(project, tree.Root, okfHome), args);
    ...
    public void RegistryVerboseNamesTheRegistryFile()
    {
        ...
        var run = CliHarness.RunIn(home.Root, home.Root, "registry", "--verbose");
    ...
    public void RegistryVerboseReportsTheGlobalAutoRegisterSetting()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "registry", "--verbose");
    ...
    public void McpVerboseReportsTheFixedScopeAndThatItIsReady()
    {
        ...
        var run = McpHarness.Run(CliHarness.Environment(tree.Root, tree.Root), ["--scope", "project", "--verbose"]);
    ...
    public void McpWithoutVerboseStartsSilently()
    {
        ...
        var run = McpHarness.Run(CliHarness.Environment(tree.Root, tree.Root), []);
    ...
    public void AResolutionNoteIsReportedBetweenTheSentenceAndTheBundles()
    {
        ...
        var workingSet = OkfDiscovery.Resolve(tree.Root, CliHarness.Environment(tree.Root, tree.Root));
