...
public class CliSurfaceTests
{
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root);
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "version");
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "version", flag);
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "lint", "--list-rules");
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, command);
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "lint", Path.Combine(home.Root, "nowhere"));
    ...
    public void NoVaultAnywhereIsAnEnvironmentFailure()
    {
        ...
        var run = CliHarness.RunIn(workingDirectory, tree.Root, "lint");
    ...
    public void AVaultPathLintsEveryBundleInIt()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "lint", Path.Combine(tree.Root, "okf"));
