...
public class SiteAndBundleReportTests
{
    ...
    public void SiteJsonSaysWhenItWroteOneSelfContainedFile()
    {
        ...
        var singleRun = CliHarness.RunIn(tree.Root, tree.Root, "site", "--out", single, "--single-file", "--json");
        var multiRun = CliHarness.RunIn(tree.Root, tree.Root, "site", "--out", multi, "--json");
    ...
    public void SiteTextReportNamesTheLandingPageToOpen()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "site", "--out", "site");
    ...
    public void BundleReportsItsSizeInBytesOrKilobytes(int bodyLength, string expected)
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "bundle", "--out", destination);
    ...
    public void BundleReportsDanglingLinksInTheRightNumber(int links, string expected)
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "bundle", "--out", Path.Combine(tree.Root, "dist.tar.gz"));
