...
public class McpAcceptanceTests
{
    ...
    public void TheDogfoodBundleSupportsAWholeDisclosureWalk()
    {
        ...
        var run = Mcp.Session(
            Cli.Environment(home.Root, home.Root),
            vault,
            Mcp.Initialize(),
            Mcp.Request(2, "tools/list"),
            Mcp.Call(3, "okf_list"),
            Mcp.Call(4, "okf_list", """{"bundle":"okf-net"}"""),
            Mcp.Call(5, "okf_search", """{"query":"trust tier","limit":3}"""));
        ...
        var second = Mcp.Session(
            Cli.Environment(home.Root, home.Root),
            vault,
            Mcp.Call(1, "okf_read", $$"""{"path":"{{first.GetProperty("path").GetString()}}"}"""),
            Mcp.Call(2, "okf_read", $$"""{"path":"{{first.GetProperty("id").GetString()}}"}"""));
    ...
    public void TheReferenceBundlesAreSearchableThroughMcpExactlyAsThroughTheCli()
    {
        ...
        using var home = new TempTree();
        var environment = Cli.Environment(home.Root, home.Root);

        var cli = Cli.Run(environment, "search", "revenue recognition", vault, "--json", "--limit", "3");
        var run = Mcp.Session(
            environment,
            vault,
            Mcp.Call(1, "okf_search", """{"query":"revenue recognition","limit":3}"""));
    ...
    public void AForeignBundleListsThroughItsOwnHandWrittenIndexAndReadsThroughMcp()
    {
        ...
        var run = Mcp.Session(
            ...
            vault,
            Mcp.Call(1, "okf_list"),
            Mcp.Call(2, "okf_list", """{"bundle":"acme_retail"}"""),
            Mcp.Call(3, "okf_list", """{"bundle":"acme_retail","path":"policies"}"""),
            Mcp.Call(4, "okf_read", """{"path":"policies/revenue-recognition","bundle":"acme_retail"}"""));
    ...
    public void AnMcpSessionWritesNothingToTheBundlesItServes()
    {
        ...
        var run = Mcp.Session(
            ...
            vault,
            Mcp.Initialize(),
            Mcp.Call(2, "okf_list", """{"bundle":"stackoverflow"}"""),
            Mcp.Call(3, "okf_search", """{"query":"metric definition"}"""),
            Mcp.Call(4, "okf_read", """{"path":"tables/events_","bundle":"ga4"}"""));
