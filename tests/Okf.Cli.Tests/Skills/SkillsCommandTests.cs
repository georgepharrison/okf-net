...
namespace Okf.Cli.Tests.Skills;
...
public class SkillsCommandTests
{
    ...
    public void HelpExitsZeroAndDescribesTheSubcommands()
    {
        ...
        var run = CliHarness.RunIn(home.Root, home.Root, "skills", "--help");
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "skills", "list");
    ...
    public void ListIsTheDefaultSubcommand()
    {
        ...
        Assert.Equal(
            CliHarness.RunIn(home.Root, home.Root, "skills", "list").Output,
            CliHarness.RunIn(home.Root, home.Root, "skills").Output);
    }
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, ["skills", .. arguments]);
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, ["skills", .. arguments, "--help"]);
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "skills", "path", "okf-capture");
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "skills", "path", "okf-nonesuch");
    ...
    public void InstallWritesTheDataCopyAndPathThenFindsIt()
    {
        ...
        var install = CliHarness.RunIn(project, home.Root, "skills", "install");
        ...
        var path = CliHarness.RunIn(project, home.Root, "skills", "path", "okf-capture");
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "skills", "install");
    ...
    {
        using var home = new TempTree();
        CliHarness.RunIn(home.Root, home.Root, "skills", "install");
        var run = CliHarness.RunIn(home.Root, home.Root, "skills", "install");
    ...
    public void InstallIsByteIdenticalBetweenRuns()
    {
        ...
        CliHarness.RunIn(first.Root, first.Root, "skills", "install", "--dir", "out");
        CliHarness.RunIn(second.Root, second.Root, "skills", "install", "--dir", "out");
    ...
    public void ForceOverwritesTheEditedSkill()
    {
        ...
        var run = CliHarness.RunIn(home.Root, home.Root, "skills", "install", "--force");
    ...
    {
        using var home = new TempTree();
        CliHarness.RunIn(home.Root, home.Root, "skills", "install", "--host", "all");
    ...
    {
        using var home = new TempTree();
        CliHarness.RunIn(home.Root, home.Root, "skills", "install", "--host", "claude");
    ...
    public void ProjectScopeWritesBesideTheProject()
    {
        ...
        CliHarness.RunIn(project, home.Root, "skills", "install", "--host", "claude", "--scope", "project");
    ...
    public void ProjectScopeAlsoWritesTheAgentsMdContextPointer()
    {
        ...
        var run = CliHarness.RunIn(project, home.Root, "skills", "install", "--scope", "project");
    ...
    public void NoAgentsMdSkipsThePointerUnderProjectScope()
    {
        ...
        var run = CliHarness.RunIn(project, home.Root, "skills", "install", "--scope", "project", "--no-agents-md");
    ...
    public void ADirectoryInstallWritesThereAndNowhereElse()
    {
        ...
        var run = CliHarness.RunIn(home.Root, home.Root, "skills", "install", "--dir", target);
    ...
    public void AProjectCopyIsWhatPathReportsEvenWhenTheUserLevelOneExists()
    {
        using var home = new TempTree();
        var project = home.CreateDirectory("project");
        CliHarness.RunIn(project, home.Root, "skills", "install");
        var vendored = home.Write("project/skills/okf-custodian/SKILL.md", "vendored\n");

        var run = CliHarness.RunIn(project, home.Root, "skills", "path", "okf-custodian");
    ...
    public void EveryRecipePointerResolvesAfterAnInstallIntoTheProjectsOwnSkillsDirectory()
    {
        ...
        CliHarness.RunIn(project, home.Root, "skills", "install", "--dir", Path.Combine(project, "skills"));
    ...
    public void TheDescriptorInAScaffoldedRecipeIsACommandThisCliRunsAndItResolves()
    {
        ...
        CliHarness.RunIn(project, home.Root, "skills", "install");
        var run = CliHarness.RunIn(project, home.Root, descriptor[1..]);
