...
public sealed class UpgradeCommandTests
{
    ...
    public void BadUsageExitsTwo(string argument)
    {
        ...
        var run = Cli.RunIn(home.Root, home.Root, "upgrade", argument);
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "upgrade", "--version", "1.0.0", "--channel", "rc");
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "upgrade", "--help");
