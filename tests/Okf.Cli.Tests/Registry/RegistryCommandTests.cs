...
namespace Okf.Cli.Tests.Registry;
...
public class RegistryCommandTests
{
    ...
    public void RegisteringIsIdempotentAndWritesTheRegistryOnce()
    {
        ...
        var first = CliHarness.RunIn(project, home.Root, "register");
        var registry = RegistryPath(home);
        var written = File.ReadAllText(registry);
        var second = CliHarness.RunIn(project, home.Root, "register");
    ...
    public void WithNoProjectVaultRegisterTargetsThePersonalVault()
    {
        ...
        var run = CliHarness.RunIn(elsewhere.Root, home.Root, "register");
    ...
    public void ABareBundleRegistersAsABundle()
    {
        ...
        var run = CliHarness.RunIn(home.Root, home.Root, "register", bundle);
    ...
    public void RegisteringSomethingThatIsNotThereIsTheUsageExitCodeAndWritesNothing()
    {
        ...
        var run = CliHarness.RunIn(home.Root, home.Root, "register", "nowhere");
    ...
    public void UnregisteringWorksByPathOrIdAndAnUnknownOneSucceeds()
    {
        ...
        var project = home.CreateDirectory("widgets");
        CliHarness.RunIn(project, home.Root, "init");
        CliHarness.RunIn(project, home.Root, "register");

        var unknown = CliHarness.RunIn(home.Root, home.Root, "unregister", "never-registered");
        var byId = CliHarness.RunIn(home.Root, home.Root, "unregister", "widgets");
    ...
    public void ListingReportsIdKindPathAndWhetherThePathIsStillThere()
    {
        ...
        CliHarness.RunIn(home.Root, home.Root, "register", gone);
        Directory.Delete(gone, recursive: true);

        var run = CliHarness.RunIn(home.Root, home.Root, "registry", "list");
    ...
    public void PruningRemovesOnlyMissingEntries()
    {
        ...
        var pruned = CliHarness.RunIn(home.Root, home.Root, "registry", "prune");
        var again = CliHarness.RunIn(home.Root, home.Root, "registry", "prune");
    ...
    public void AnUnknownRegistrySubcommandIsAUsageFailure()
    {
        ...
        var run = CliHarness.RunIn(home.Root, home.Root, "registry", "forget");
    ...
    public void AutoRegisterIsRecordedAndReportedButRegistersNothing()
    {
        ...
        var listed = CliHarness.RunIn(project, home.Root, "registry", "list", "--verbose");
    ...
    public void AutoRegisterInAProjectConfigIsRefusedByTheCommandsThatReadConfiguration()
    {
        ...
        var run = CliHarness.RunIn(project, home.Root, "lint");
    ...
    {
        var run = CliHarness.RunIn(home.Root, home.Root, "registry", "list", "--json");
        Assert.Equal(CliApplication.ExitSuccess, run.ExitCode);
