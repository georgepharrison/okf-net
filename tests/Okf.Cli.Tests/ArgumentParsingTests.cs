...
public class ArgumentParsingTests
{
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, verb, "--frobnicate");
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "registry", "--format=xml");
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "mcp", "--scope");
    ...
    public void SearchFiltersNarrowTheResults(string flag, string value, int expected)
    {
        ...
        var run = Cli.RunIn(tree.Root, tree.Root, "search", "widget", flag, value, "--format", "json");
    ...
    public void LimitCapsTheResults(string first, string? second)
    {
        ...
        var unlimited = Cli.RunIn(tree.Root, tree.Root, "search", "widget", "--format", "json");
        var limited = Cli.RunIn(tree.Root, tree.Root, args);
