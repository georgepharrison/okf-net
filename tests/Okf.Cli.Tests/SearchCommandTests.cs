...
public class SearchCommandTests
{
    ...
    public void HelpExitsZeroAndDescribesTheFlags()
    {
        ...
        var run = Cli.RunIn(home.Root, home.Root, "search", "--help");
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "search", "widget", argument);
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "search", "widget", "path", "extra");
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "search", query);
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "search");
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "search", "widget", Path.Combine(home.Root, "nowhere"));
    ...
    public void TheTextReportIsLinksFirstAndCarriesTrustAndStalenessMarkers()
    {
        ...
        var run = Cli.RunIn(tree.Root, tree.Root, "search", "widget", bundle);
    ...
    public void NoMatchesIsNotAnError()
    {
        ...
        var run = Cli.RunIn(tree.Root, tree.Root, "search", "unobtainium", bundle);
    ...
    public void ReservedFilesAreNeverSearched()
    {
        ...
        var run = Cli.RunIn(tree.Root, tree.Root, "search", "phlogiston", bundle);
    ...
    public void TheDropZoneOutsideTheBundlesIsNeverSearched()
    {
        ...
        var widgets = Cli.RunIn(project, tree.Root, "search", "widget");
        var phlogiston = Cli.RunIn(project, tree.Root, "search", "phlogiston");
    ...
    public void AndFallsBackToOrAndSaysSo()
    {
        ...
        var run = Cli.RunIn(tree.Root, tree.Root, "search", "widget unobtainium", bundle);
    ...
    public void TheLimitTruncatesAndSaysSo()
    {
        ...
        var run = Cli.RunIn(tree.Root, tree.Root, "search", "widget", bundle, "--limit", "1");
    ...
    public void FilterFlagsAreTheInlineFilterSyntaxByAnotherSpelling()
    {
        ...
        var inline = Cli.RunIn(tree.Root, tree.Root, "search", "widget tag:catalog type:Reference", bundle);
        var flags = Cli.RunIn(
    ...
    public void TheSameCorpusAndQueryProduceByteIdenticalOutput()
    {
        ...
        var text = Cli.RunIn(tree.Root, tree.Root, "search", "widget catalog", bundle);
        var again = Cli.RunIn(tree.Root, tree.Root, "search", "widget catalog", bundle);
        var json = Cli.RunIn(tree.Root, tree.Root, "search", "widget catalog", bundle, "--json");
        var jsonAgain = Cli.RunIn(tree.Root, tree.Root, "search", "widget catalog", bundle, "--json");
    ...
    public void JsonIsTheStableSortedResultContract()
    {
        ...
        var run = Cli.RunIn(tree.Root, tree.Root, "search", "widget", bundle, "--json");
    ...
    public void ItResolvesAVaultTheSameWayLintDoes()
    {
        ...
        var run = Cli.RunIn(project, tree.Root, "search", "widget", "--verbose");
    ...
    public void AFileThatDoesNotParseIsSkippedAndReportedUnderVerbose()
    {
        ...
        var run = Cli.RunIn(tree.Root, tree.Root, "search", "widget", bundle, "--verbose");
