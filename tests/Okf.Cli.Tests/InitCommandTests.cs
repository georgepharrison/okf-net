...
public class InitCommandTests
{
    ...
    public void HelpExitsZeroAndDescribesTheFlags()
    {
        ...
        var run = Cli.RunIn(home.Root, home.Root, "init", "--help");
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "init", argument);
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "init", "one", "two");
    ...
    {
        using var home = new TempTree();
        var run = Cli.RunIn(home.Root, home.Root, "init", ".", "--personal");
    ...
    public void TheHappyPathScaffoldsAVaultThatLintsCleanAndHasNoIndexDrift()
    {
        ...
        var index = Cli.RunIn(project, home.Root, "index", "--check", "okf");
    ...
    public void PointingInitAtAnInitializedVaultIsAlsoANoOp()
    {
        ...
        var run = Cli.RunIn(project, home.Root, "init", "okf");
    ...
    public void InitializingInsideABundleRootIsRefusedAndWritesNothing()
    {
        ...
        var run = Cli.RunIn(bundleRoot, home.Root, "init");
    ...
    public void TheScaffoldedVaultMatchesThisRepositorysHandBuiltOne()
    {
        ...
        Assert.Equal(CliApplication.ExitSuccess, Cli.RunIn(project, home.Root, "init").ExitCode);
