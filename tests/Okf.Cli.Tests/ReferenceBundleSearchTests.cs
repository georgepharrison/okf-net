...
public class ReferenceBundleSearchTests
{
    ...
    public void SearchingTheReferenceBundlesRanksTheConceptTheQueryNames()
    {
        ...
        var run = Cli.RunIn(home.Root, home.Root, "search", "revenue recognition", vault, "--json", "--limit", "3");
    ...
    public void FiltersWorkOnBundlesOkfNetDidNotProduce()
    {
        ...
        var run = Cli.RunIn(home.Root, home.Root, "search", "type:Metric", vault, "--json", "--limit", "50");
    ...
    public void SearchingTheCloneIsRepeatableAndWritesNothingToIt()
    {
        ...
        var first = Cli.RunIn(home.Root, home.Root, "search", "metric definition", vault);
        var second = Cli.RunIn(home.Root, home.Root, "search", "metric definition", vault);
