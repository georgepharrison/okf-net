...
public class InboxCommandTests
{
    ...
    public void HelpExitsZeroAndDescribesTheReasons()
    {
        ...
        var run = CliHarness.RunIn(home.Root, home.Root, "inbox", "--help");
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "inbox", argument);
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "inbox", "one", "two");
    ...
    {
        using var home = new TempTree();
        var run = CliHarness.RunIn(home.Root, home.Root, "inbox");
    ...
    public void EachReasonGetsItsOwnGroupWithADetailLine()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle);
    ...
    public void FailIfAnyTurnsANonEmptyInboxIntoExitOne()
    {
        ...
        var reported = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle);
        var gated = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle, "--fail-if-any");
    ...
    public void FailIfAnyStillExitsZeroWhenNothingIsWaiting()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle, "--fail-if-any");
    ...
    public void TheJsonIsAStableArrayCarryingEveryFieldAJudgementNeeds()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle, "--format", "json");
    ...
    public void AbsentFrontmatterBecomesJsonNullRatherThanAMissingKey()
    {
        ...
        var run = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle, "--json");
    ...
    public void VerboseReportsResolutionOnStderrAndLeavesTheContractAlone()
    {
        ...
        var quiet = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle, "--json");
        var loud = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle, "--json", "--verbose");
    ...
    public void EverySpellingOfTheJsonFlagProducesTheSameArray(string flag)
    {
        ...
        var inline = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle, flag);
        var spaced = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle, "--format", "json");
    ...
    public void FormatTextIsTheDefaultAndIsNotJson()
    {
        ...
        var explicitText = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle, "--format", "text");
        var implicitText = CliHarness.RunIn(tree.Root, tree.Root, "inbox", bundle);
