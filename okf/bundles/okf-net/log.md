...
* **Update**: `OKF0310` (raw-item-mutated) joined the rule set as okf-net's first vault-scoped diagnostic, promoted to error in `okf/okf.json`. Catalogued in [the lint severity model](toolset/lint-severity-model.md).
